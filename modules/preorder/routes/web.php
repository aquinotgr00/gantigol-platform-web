...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::get('pending-transaction/{id}', 'TransactionController@pending')->name('pending.transaction');
    Route::get('paid-transaction/{id}', 'TransactionController@paid')->name('paid.transaction');
    Route::get('shipping-transaction/{id}', 'TransactionController@shipping')->name('shipping.transaction');
    Route::get('batch-transaction/{id}', 'TransactionController@batch')->name('batch.transaction');
    ...
    Route::get('setting-reminder', 'SettingReminderController@index')->name('setting-reminder.index');
    Route::post('setting-reminder', 'SettingReminderController@store')->name('setting-reminder.store');
    Route::get('setting-shipping', 'SettingShippingController@index')->name('setting-shipping.index');
