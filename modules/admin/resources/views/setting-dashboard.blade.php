                    ...
                    <div class="row">
                      <div class="col-4">
                        <div class="form-group">
                          <form class="dropzone dropzone-secondary needsclick dz-clickable" id="demo-upload" action="/upload">
              ...
              <div class="pt-3 pb-3">
                ...
                <div class="form-check mb-3">
                  <input type="checkbox" class="form-check-input" id="UploadNewMedia">
                    <label class="form-check-label style-privilage" for="UploadNewMedia">COD</label>
                </div>
                <div class="form-check mb-3">
                  <input type="checkbox" class="form-check-input" id="UploadNewMedia">
                    <label class="form-check-label style-privilage" for="UploadNewMedia">JNE</label>
                </div>
                <div class="form-check mb-3">
                  <input type="checkbox" class="form-check-input" id="UploadNewMedia">
                    <label class="form-check-label style-privilage" for="UploadNewMedia">JNT</label>
                </div>
                <div class="form-check mb-3">
                  <input type="checkbox" class="form-check-input" id="UploadNewMedia">
                    <label class="form-check-label style-privilage" for="UploadNewMedia">Pos Indonesia</label>
                </div><div class="form-check mb-3">
                  <input type="checkbox" class="form-check-input" id="UploadNewMedia">
                    <label class="form-check-label style-privilage" for="UploadNewMedia">Tiki</label>
                </div>
              </div>
