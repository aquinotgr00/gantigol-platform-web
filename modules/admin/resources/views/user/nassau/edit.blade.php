...
<form method="post" action="{{ route('users.update',$user) }}">
    ...
    <div class="row pl-3">
        <div class="col-md-6 col-lg7 pl-0">
            ...
            <div class="form-group">
                <label for="password_confirmation">Confirm Admin Password</label>
        ...
        <div class="form-group col-md-4 col-lg-5 pl-5 grs">
            <label for="select-role">Privilage Management</label>
            @if ($errors->has('privilege'))
            <span class="text-danger">{{ $errors->first('privilege') }}</span>
            @endif
            <select name="role_id" class="form-control" id="select-role" @cannot('edit-user-privileges',$user) disabled @endcannot>
