@extends('emails.layouts.gantigol')
@section('content')
    ...
    <tbody>
        <tr style="padding: 0; text-align: left; vertical-align: top;">
            <td style="padding: 10px; background: #eaeaea; border: 1px #CCC solid;">
                <h3 style="font-size:18px; font-weight:bold; margin:0px">Transaksi anda telah dibatalkan</h3>
                <p style="font-size:14px;margin-top:0px; font-weight:bold;">Alasan : pembayaran anda belum kami terima hingga batas waktu yang telah ditentukan</p>
