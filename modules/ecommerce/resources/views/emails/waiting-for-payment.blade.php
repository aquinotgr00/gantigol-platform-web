    ...
    <tbody>
        <tr style="padding: 0; text-align: left; vertical-align: top;">
            <td style="padding: 10px; background: #eaeaea; border: 1px #CCC solid;">
                ...
                <p>Checkout berhasil pada {{$order->created_at->format('ecommerce::d M Y H:i')}}</p>
                ...
                <p style="font-size:14px;margin-top:0px; font-weight:bold;">Batas waktu pembayaran : {{$order->created_at->addMinutes(config('ecommerce::starcross.transferBca.expired.amount'))->format('ecommerce::d M Y H:i')}}</p>
            </td>
        </tr>
    </tbody>
</table>
