            ...
            <div class="row pl-3">
              <form class="col-md-6 col-lg7 pl-0" id="form-post-create" action="{{Route('blog.post.store')}}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tags" class="form-control" id="exampleInputCategoryPrize" data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label for="exampleInputCategoryPrize">Keywords</label>
                  <input type="text" name="keywords" class="form-control" id="exampleInputCategoryPrize" data-role="tagsinput">
                </div>
